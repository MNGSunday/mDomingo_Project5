...
The following code was borrowed from the user Brakeys on GitHub for the purpose of this assignment. See link in README.
*/
using UnityEngine;
using UnityEngine.Events;

// The following code represents the concept of a character's basic controls within a game and contains functions to simulate the control the properties of a player.
